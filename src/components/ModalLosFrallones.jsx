...
const ModalLosFrallones = ({ setIsModalActive, data }) => {
    ...
    return (
        ...
        >
            ...
            style={{ backgroundImage: `url(${LosFrallones})` }} // Establecer imagen de fondo
            >

                <h1>Los Farallones</h1>
...
export default ModalLosFrallones;
